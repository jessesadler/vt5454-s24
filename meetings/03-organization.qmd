...
## Assignment
- Download [Zotero](https://www.zotero.org) if you have not already and read over the [Zotero Guide](/guides/zotero.qmd) and look through [Zotero's documentation](https://www.zotero.org/support/).
...
- How to store your PDFs
  ...
  - The [zotmoov](https://github.com/wileyyugioh/zotmoov) extension provides a way to move files to an external folder.
  - You can also customize how PDFs are named. See the [documentation](https://www.zotero.org/support/file_renaming) on how to set this up.
