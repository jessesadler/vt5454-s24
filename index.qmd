...
We will be using two pieces of technology to help with collaboration during the semester. We will use [Discord](https://discord.com) to provide a place to ask questions and receive feedback outside of the seminars. The Discord will also be a place for any announcements about the course. See [Resources: Discord](resources.qmd#sec-discord) for instructions on getting set up with Discord. Secondly, we will be using [Zotero groups](https://www.zotero.org/groups/) as a way to collaboratively keep track of the resources we use for the class. See [Resources: Zoetero](resources.qmd#sec-zotero) for instructions on getting set up with Zotero.
