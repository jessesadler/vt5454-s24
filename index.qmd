---
title: "History 5454: Digital History for Public History"
---
...
Office hours: Thursday, 1:00--2:00pm and by appointment in Major Williams 4th floor
:::
...
We will be using two pieces of technology to help with collaboration during the semester. We will use [Discord](https://discord.com) to provide a place to ask questions and receive feedback outside of the meetings. The Discord will also be a place for any announcements about the course. See [Resources: Discord](resources.qmd#sec-discord) for instructions on getting set up with Discord. Secondly, we will be using [Zotero groups](https://www.zotero.org/groups/) as a way to collaboratively keep track of the resources we use for the class. See [Resources: Zoetero](resources.qmd#sec-zotero) for instructions on getting set up with Zotero.

::: {.callout-tip icon=false}
## Note
This website is built with [Quarto](https://quarto.org) and the source code is available on GitHub. If you want to see how anything works or to suggest any changes you can do so through [GitHub](https://github.com/jessesadler/vt5454-s24).
:::
...
11. [Review and website workshop][11] (4 April)
12. [Spatial analysis][12] (11 April)
13. [Network analysis][13] (18 April)
14. [Web design and visualization][14] (25 April)
15. [Conclusion][15] (2 May)

Appendix: [Text analysis][16]
...
[11]: meetings/11-review.qmd
[12]: meetings/12-spatial.qmd
[13]: meetings/13-network.qmd
[14]: meetings/14-design.qmd
[15]: meetings/15-conclusion.qmd
[16]: meetings/16-text.qmd
